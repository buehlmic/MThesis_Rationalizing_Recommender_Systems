...
'''
    ...
    Modifications 2017 Michael Bühler under the Apache License 2.0
'''
...
from initialization import get_activation_by_name, sigmoid, linear, default_rng
from basic import EmbeddingLayer, Layer, RecurrentLayer, LSTM, apply_dropout
from advanced import RCNN
from initialization import create_shared, random_init
...
class ExtLSTM(LSTM):
    ...
    def forward(self, x_t, mask_t, hc_tm1):
        ...
        hc_t = mask_t.dimshuffle(0, 'x') * hc_t + (1-mask_t).dimshuffle(0,'x') * hc_tm1
        return hc_t
